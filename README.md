...
The site includes an optional chatbot that answers questions about Anusha using RAG (retrieval-augmented generation). The knowledge base is built from various career and project-related documents. 
